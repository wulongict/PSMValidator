...
//
//void train_for_different_peptide_length(const string &scoretype, CPeakPairsImporter &target_SubData,
//                                        CPeakPairsImporter &decoy_subData, int startlen, int endlen) {
//    for (int peplen = startlen; peplen < endlen; peplen++) {
//
//        CPeakPairsImporter target_SubSetLen, decoy_SubSetLen;
//        target_SubData.getSubsetOnPepLen(target_SubSetLen, peplen);
//        decoy_subData.getSubsetOnPepLen(decoy_SubSetLen, peplen);
//        if (target_SubSetLen.size() == 0) {
//            cout << "[Info] Empty data set with peptide length " << peplen << endl;
//            continue;
//        }
//
//        trainFragmentModel(scoretype, target_SubSetLen, decoy_SubSetLen);
//
//
//        // hwo to make use of those information?
//// hwo to compare with other sources?
//// how about the symmetric pattern?
//// two zero peaks... generates no features, one generates many.
//
//    }
//}
...
// a new workflow
// read features
// /data/wulong/data/NIST/remove5_add45_3001_0_300000/test_remove5_add45_3001_0_300000.mgf_titlefrag.txt
// load a model
// do some prediction
// calculate score